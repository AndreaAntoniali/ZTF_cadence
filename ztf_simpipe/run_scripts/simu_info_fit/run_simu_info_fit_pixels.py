...
simu_cmd = cmd(
    'python run_scripts/simulation/run_simulation_pixels.py --nprocSimu=4', confDict_simu)
os.system(simu_cmd)

# info
print('Info in progress...')
info_cmd = cmd('python run_scripts/info/run_info.py --nproc=4', confDict_info)
os.system(info_cmd)

# fit lc
print('Fit LC in progress...')
fit_cmd = cmd('python run_scripts/fit_lc/run_fit_lc.py --nprocFit=4', confDict_fit)
os.system(fit_cmd)
